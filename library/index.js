...
(function (Jsonarch) {
    ...
    Jsonarch.isCallTemplateCache = Jsonarch.isObject({ template: Jsonarch.isIntermediateTemplateData, parameter: Jsonarch.isIntermediate, cacheKey: Jsonarch.isString, result: Jsonarch.isJsonable, });
